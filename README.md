...
Perform calculations on product and packaging data to determine shipping and storage metrics.

Objectives:
- Transform raw product dimensions
...
Analyze sales data and determine inventory planning metrics.
...
- A small number of campaigns generate the majority of sales revenue.
- Higher ad spend does not always produce higher **ROAS**.
